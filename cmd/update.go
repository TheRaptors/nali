...
var updateCmd = &cobra.Command{
	Use:     "update [--db dbs -v]",
	Short:   "update qqwry, zxipv6wry, ip2region, ip2region-ipv6 ip database and cdn, update nali to latest version if -v",
	Long:    `update qqwry, zxipv6wry, ip2region, ip2region-ipv6 ip database and cdn. Use commas to separate. update nali to latest version if -v`,
